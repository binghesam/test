...
def sent_generator(revisions):
    ...
    for rev_id in tqdm(revisions):
        ...
        print("0 {}".format(prevs))
        print("0 {}".format(posts))
        # empty revision
        ...
        print("3 {}".format(prev_text))
        print("3 {}".format(post_text))
        # failed cleaning
...
out = []
print("in sentence generator")
sent_generator(revisions)
